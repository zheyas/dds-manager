...
urlpatterns = [
    ...
    path('operations/create/expense/', views.CashFlowCreateExpenseView.as_view(), name='cashflow_create_expense'),
    path('operations/<int:pk>/edit/', views.CashFlowUpdateView.as_view(), name='cashflow_update'),
    path('operations/<int:pk>/delete/', views.CashFlowDeleteView.as_view(), name='cashflow_delete'),
